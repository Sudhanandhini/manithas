...
const PageFaq = ({ eyebrow, title, items, imageOne, imageTwo, classOption }) => {
                            ...
                            <div className="agency-accordion max-mb-n30">
                                <Accordion>
                                    {items && items.map((item, key) => (
                                        <AccordionItem id={`faq-${key}`} key={key}>
                                            <AccordionTitle id={`faq-${key}`}>{item.question}</AccordionTitle>
                                            <AccordionContent id={`faq-${key}`}>{item.answer}</AccordionContent>
                                        </AccordionItem>
                                    ))}
                                </Accordion>
                            </div>
...
PageFaq.defaultProps = {
    imageOne: "/images/faq/faq-2.jpg",
    imageTwo: "/images/faq/faq-1.jpg",
    classOption: ""
};
