...
const SwiperSlider = forwardRef<HTMLDivElement, any>(
    (
        ...
        // Swiper's slide DOM manipulation (esp. loop mode) races with React's
        // hydration diff and causes "text content did not match" errors under SSR.
        // Deferring the real Swiper mount to after the client mount sidesteps that.
        ...
        return (
            <div
                ...
                ref={ref}
            >
                {mounted ? <Swiper {...sliderOptions}>{children}</Swiper> : null}
